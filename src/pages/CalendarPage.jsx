...
import DayDetailsModal from "../components/modals/DayDetailsModal.jsx";
...
export default function CalendarPage() {
  ...
  const { events, addEvent: pushEvent, deleteEvent, updateEvent } = useEvents();
    ...
    <div className="db-root">
                    ...
                    <div className="cal-dots">
                      {evs.slice(0, 3).map((e, j) => (
                        <span
                          key={j}
                          className="cal-dot"
                          style={{ background: EVENT_META[e.type].dot }}
                        />
                      ))}
                    </div>
                  )}
      ...
      {selected && showAdd !== true && (
        <DayDetailsModal
          ...
          dateLabel={fmtLabel(year, month, selected)}
        />
      )}
