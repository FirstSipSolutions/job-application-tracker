...
import { fetchHackerNews }      from "../lib/jobs/sources/hackernews/index.js";
...
const SOURCES = [fetchSiliconHarbour, fetchDigitalNS, fetchJobBank, fetchTechNL, fetchCanadianCompanies, fetchHackerNews, fetchAdzuna, fetchGreenhouse, fetchAshby, fetchHimalayas, fetchLever, fetchWorkday, fetchSmartRecruiters, fetchWeWorkRemotely, fetchJobicy, fetchRemotive];
